                ...
                <div className='w-full md:w-2/4 my-10 md:my-0 '>
                    <div className="w-full shadow-2xl hover:shadow-xl shadow-[#FF325E]  hover:shadow-[#FF325E] rounded-lg bg-base-100">
                        <form className="card-body">
                            ...
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text">Message <span className='text-red-600'>*</span></span>
                                </label>
                                {/* <input type="password" placeholder="password" className="input input-bordered" required /> */}
                                <textarea type="password" placeholder="messages here" className="input input-bordered min-h-16" name="message" id="" cols="30" rows="10" required></textarea>
                            </div>
